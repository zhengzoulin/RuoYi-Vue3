        ...
        <el-dropdown class="el-dropdown-order" trigger="click"  >
          ...
          <template #dropdown>
            <el-dropdown-menu>
              ...
              <el-dropdown-item >新增生产计划入库单</el-dropdown-item>
...
function SelectAddStockPosition(row){
  ...
  console.log( form.value.orderProductsList.addStockProduct)
...
function handleOrderSelectionChange(data) {
  ...
  console.log("这里："+queryParams.value.unitName)
...
// 遍历 orderProductsLists 数组
  ...
  console.log("入库商品：："+ form.value.orderProductsList)
