<template>
  ...
  <div class="app-container">
    ...
    <br>
    <span style="margin-top:50px"> 出库种数：   </span>
    <!--      待领料出库商品明细表格-->
    <el-table
    ...
    >
      ...
      <el-table-column label="出库数量"   align="center"  >
        <template #default="scope">
                  <span>
                    <el-input-number v-model="scope.row.addStockNumber"  type="number" maxlength="20" placeholder="请输入出库量" size="mini"  />
                  </span>
        </template>
      </el-table-column>
    ...
    >
      ...
      <div  class="el-row" style="margin-top: 15px; margin-bottom: 15px; margin-left: 10px;">
        <span >
         可出库数量：<span  style="color: rgb(82, 153, 252);">{{ tempProduct.groupNumber }}</span> &nbsp;&nbsp;
        </span>
        已输入出库数量：<span  style="color: rgb(82, 153, 252);">计算  </span>
      </div>
